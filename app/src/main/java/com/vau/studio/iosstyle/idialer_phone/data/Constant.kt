...
const val CONTACT_READ_PERMISSION = ContactsPermissions.READ_PERMISSION
const val CONTACT_WRITE_PERMISSION = ContactsPermissions.WRITE_PERMISSION
const val GET_ACCOUNT_PERMISSION =  contacts.core.accounts.AccountsPermissions.GET_ACCOUNTS_PERMISSION
